...
depends=('qt5-base' 'qt5-graphicaleffects' 'qt5-multimedia' 'qt5-feedback' 'qt5-mpris-git' 'nemo-qml-plugin-contextkit-git' 'qt5-connman-git' 'qt5-lipstick-git' 'qt5-quickcontrols-nemo-git' 'nemo-qml-plugin-configuration-git' 'nemo-qml-plugin-statusnotifier-git' 'nemo-qml-plugin-time-git' 'nemo-qml-plugin-contacts-git' 'nemo-qml-plugin-notifications-git' 'qt5-ofono-nemo-extensions-git')
